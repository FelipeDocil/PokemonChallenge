    ...
    override func spec() {
        ...
        describe("PokemonDetailInteractorSpec") {
            ...
            it("save pokemon") {
                ...
                expect(self.mockDatabase.invokedPokemon) == true
                expect(self.mockDatabase.invokedPokemonParameters?.identifier) == 1
                expect(self.mockDatabase.invokedSaveEntries) == true

                expect(self.mockDatabase.invokedSaveEntriesParameters?.pokemon) == pokemon
                expect(self.mockDatabase.invokedSaveEntriesParameters?.entries) == entries
            }
        }
    }
}
